...
export const Sidebar: React.FC<{ inDrawer?: boolean; onCloseDrawer?: () => void }> = ({
  ...
  return (
    <aside className={`w-full ${inDrawer ? "" : "hidden lg:flex lg:w-80 flex-shrink-0 lg:h-full lg:max-h-full lg:overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700 flex-col gap-4 animate-in fade-in slide-in-from-left-4 duration-300 z-20 pb-4"}`} aria-label="Thanh điều hướng và bộ lọc">
